...
<div className="your-profile-section">
    <div className="container-fluid">
                ...
                <div className="profile-edit">
                    ...
                    { !graduateUser.picture ? <img src="/assets/df-logo-blue-background.png" alt="Digital Futures logo" className="default-profile-picture" /> : <img src={graduateUser.picture} alt="Profile Image" className="default-profile-picture" /> }
